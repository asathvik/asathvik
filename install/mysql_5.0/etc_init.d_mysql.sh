...
#	Increased timeout for shutting down instance from 35 to 60 seconds.
#	07/06/2009 - Dimitriy Alekseyev
#	Modified the script which would allow multiple instance support and 
#	read my.cnf file from each mysql directory (i.e. from /mysql_01/my.cnf).
