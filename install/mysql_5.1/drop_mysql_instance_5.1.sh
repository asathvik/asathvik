...
#	files and scripts for this instance. This script works with MySQL 5.5 
#	instances.
#
# Usage:
#	drop_mysql_instance_5.5.sh instance_number
#
# Revisions:
#	2011-07-06 - Dimitriy Alekseyev
#	Script created.
#	2011-07-08 - Dimitriy Alekseyev
#	Modified script to support MySQL version 5.5 instead of 5.0.
#	2013-03-04 - Dimitriy Alekseyev
#	Modified script to support MySQL version 5.1 instead of 5.5.
################################################################################
...
function main {
	...
	rm -v m${inst}.sh m${inst}c.sh m${inst}_passwd.txt m${inst}start.sh m${inst}stop.sh m${inst}_client_parms.cnf
	echo
