...
/software/mysql-5.1.24-rc-linux-x86_64-glibc23/bin/myisampack --force --tmpdir=/tmp -v $tables
...
/software/mysql-5.1.24-rc-linux-x86_64-glibc23/bin/myisamchk --force --recover --quick --tmpdir=/tmp -vvv $tables
...
/software/mysql-5.1.24-rc-linux-x86_64-glibc23/bin/myisamchk --analyze --tmpdir=/tmp -vvv $tables
